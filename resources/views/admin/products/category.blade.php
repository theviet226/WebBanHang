        ...
        <div class="card" style="width: 500px; height: max-content; margin-left: 20px; color:#b7c0cd; background-color: #263544;; border:none;">
            ...
            <div class="card-body">
                <form action="{{route('admin.category.store')}}" method="post"
                    ...
                    <div class="mt-2">
                        <lable style="margin-bottom: 8px; display: inline-block;">Tên tiếng anh:</lable>
            ...
            <div class="card-body" style="color:#b7c0cd">
                <table class="table " >
                    ...
                    <tr>
                        ...
                        <th scope="col" style="color:#b7c0cd">Tên tiếng anh</th>
                    ...
                    @foreach($listCategories as $category)
                        <tr>
                            ...
                            <td style="color:#b7c0cd">{{$category->name_en}}</td>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('admin.category.destroy',[$category->id])}}" class="btn
                                        btn-danger">Xóa</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('admin.category.update')}}" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="category-name"
                                           class="col-form-label">Tên tiếng anh:</label>
                                    <input type="text" class="form-control"
                                           id="category-name-en" name="name_en">
                                </div>
